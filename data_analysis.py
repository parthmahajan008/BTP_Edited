...
def main():
    ...
    for i in tqdm(range(len(sampled_data))):
        ...
        if input_i == '':
            ...
            temp_dict = {'question':ques_i,'input':input_i}
        ...
        whole_text_reverse = promt_to_use_reverse + ques_i_ori + input_i
        ...
        if rat_i == '':
            ...
            ppl_ins_alone, loss_ins_alone = get_perplexity_and_embedding_whole_text(tokenizer, model, ques_i_ori+input_i, args.max_length-ques_i_reverse_len+1)
